...
public:
  ...
  static const int Sign(float input);
  static const float ShortestDistanceBetweenTwoAngles(float angle1, float angle2);
  static const int GetDirectionToRotate(float angle1, float angle2);
};
